...
// Modify your dashboard template to display selected courses
$selected_courses = get_user_meta( get_current_user_id(), 'selected_courses', true );
...
if ( $selected_courses ) {
    foreach ( $selected_courses as $course_id ) {
        ...
        if ( $course ) {
            ...
            echo '<h2>' . get_the_title( $course_id ) . '</h2>';
            echo '<p>' . get_the_excerpt( $course_id ) . '</p>';
        }
    }
}
