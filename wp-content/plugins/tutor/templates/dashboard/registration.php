		...
		<form method="post" enctype="multipart/form-data" id="tutor-registration-form">
			...
			<form method="post" enctype="multipart/form-data" id="tutor-registration-form">
				...
				<div class="tutor-form-row">
					<div class="tutor-form-col-6">
						<div class="tutor-form-group">
							<label for="subject"><?php esc_html_e('Subject', 'tutor'); ?></label>
							<select name="subject" id="subject" required>
								<option value=""><?php esc_html_e('Select a subject', 'tutor'); ?></option>
								<option value="physics"><?php esc_html_e('Physics', 'tutor'); ?></option>
								<option value="chemistry"><?php esc_html_e('Chemistry', 'tutor'); ?></option>
								<option value="biology"><?php esc_html_e('Biology', 'tutor'); ?></option>
							</select>
						</div>
					</div>
				</div>
				...
				<select name="selected_courses[]" multiple>
					<option value="course_id_1">Course 1</option>
					<option value="course_id_2">Course 2</option>
			...
			<div id="selected-courses">
				<?php
				$selected_courses = isset($_SESSION['selected_courses']) ? $_SESSION['selected_courses'] : array();
				foreach ($selected_courses as $course_id) {
					$course_title = get_the_title($course_id);
					echo "<p>$course_title</p>";
				}
				?>
			</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('tutor-registration-form').addEventListener('submit', function(event) {
            ...
            // Redirect to archive-course.php
